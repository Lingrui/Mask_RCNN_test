...
class DSBDataset(utils.Dataset):
    def load_DSB(self, dataset_dir, subset, year=DEFAULT_DATASET_YEAR, class_ids=None,
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN on DSB.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'evaluate' on DSB")
    parser.add_argument('--dataset', required=True,
                        metavar="/path/to/coco/",
                        help='Directory of the DSB dataset')
